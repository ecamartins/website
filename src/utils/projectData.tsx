...
export const bioText: ReactNode = <>Hi! My name is Emily. I recently graduated from the University of Victoria with a BSc in Computer Science with Honours.<br /><br />Throughout my undergrad I gained industry, teaching, and research experience. I worked 2 internships; one as a front-end developer at Schneider Electric and another at Arista Networks, writing software for internet switches. I've also worked as a teaching assistant for various courses, including (a) introductory C programming (CSC111), (b) algorithms and data structures (CSC225), and (c) foundations of computer science (CSC 320). In terms of research, I completed my Honours thesis project in the area of GPU computing, supervised by Dr. Sean Chester. I also undertook research funded by NSERC USRA and NSERC CREATE in the area of complexity theory and quantum computing; our paper was accepted at QCE25.<br /><br />I am extremely passionate about GPU computing. I enjoy finding creative ways to exploit parallelism and strategically use the GPU memory and thread hierarchies to optimize algorithms. I got experience designing and implementing GPU algorithms during my undergrad. Now, I am fortunate to work at AMD, working on Stream-K in ROCm's Composable Kernel library.<br /><br />In my spare time, you can primarily find me training aerial silks, but I also enjoy hiking and running!</>;
